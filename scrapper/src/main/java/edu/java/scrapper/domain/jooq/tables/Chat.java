...
public class Chat extends TableImpl<ChatRecord> {
     ...
     */
    public final TableField<ChatRecord, Short> STATE = createField(DSL.name("STATE"),
        SQLDataType.SMALLINT.nullable(false).defaultValue(DSL.field(DSL.raw("0"), SQLDataType.SMALLINT)),
        this,
        ""
    );
     ...
     */
    public <U> SelectField<U> mapping(Function2<? super Long, ? super Short, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function2<? super Long, ? super Short, ? extends U> from) {
